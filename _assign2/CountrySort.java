...
public class CountrySort {
	...
	public static void main(String[] args) {
		...
		Comparator<String> reverseAlphabetic = new Comparator<String>() {
			@Override
		...
		Comparator<String> countAs = new Comparator<String>() {
			@Override
			public int compare(String s1, String s2) {
				return getCharacterAOccurrence(s2) - getCharacterAOccurrence(s1);
			}
		};
	...
	public static int getCharacterAOccurrence(String word) {
		int count = 0;
